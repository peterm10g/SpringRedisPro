...
public abstract class AbstractJedisService<K, V> implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        redisTemplate.setKeySerializer(new FastjsonSerializer<>(getKeyType()));  //设置key序列化器
        redisTemplate.setValueSerializer(new FastjsonSerializer<>(getValueType()));  //设置value序列化器
    }
    ...
    abstract protected Class<K> getKeyType();
